...
def start_bot():
    ...
    for cookie in COOKIES['gourav']:
        driver.add_cookie(cookie)

    driver.get("https://www.linkedin.com")
    linkedinProfiles(driver, "Saas Companies", "shine_Java", 5)
    # linkedinProfiles(driver, "Saas Companies", "django", 5)
    ...
    exportData("Prospects", "Indian Startup Prospects")
    driver.close()
